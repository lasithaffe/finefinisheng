...
window.addEventListener('scroll', function() {
  ...
  scrollRef <= 10 ? scrollRef++ : AOS.refresh();
    ...
    $('.menu-item-1787 > a').click(function() {
        $('.menu-item-1787 > .sub-menu').toggleClass('open-sub');
    });

    $('.menu-item-1459 > a').click(function() {
        $('.menu-item-1459 > .sub-menu').toggleClass('open-sub');
    });
